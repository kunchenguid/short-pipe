/**
 * Restrained thin-stroke line icons - real Lucide (lucide.dev, ISC) path data
 * inlined so the renderer ships no icon font or sprite. Per the design system
 * (short-pipe-design README section 4): icons support a label, never stand in
 * for one; ink-2/ink-3 by default, vermillion only when active, 1.75px stroke.
 */
...
const ICON_PATHS = {
  ...
  fileVideo:
    '<path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M15.5 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5z"/><path d="m10 11 5 3-5 3z"/>',
  shield:
  ...
  captions:
    '<rect width="18" height="14" x="3" y="5" rx="2"/><path d="M7 15h4"/><path d="M15 15h2"/><path d="M7 11h2"/><path d="M13 11h4"/>',
...
export function Icon({
  ...
  return (
    <svg
      ...
      aria-hidden="true"
      // biome-ignore lint/security/noDangerouslySetInnerHtml: static, in-repo Lucide path data
